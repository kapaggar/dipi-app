...
private val FINDING_TITLES = mapOf(
    ...
    "aadhar_masked" to "Aadhaar number is masked",
    "aadhar_length" to "Aadhaar is the wrong length",
    "id_type_mismatch" to "ID type does not match the document",
    "pan_invalid" to "PAN format is invalid",
